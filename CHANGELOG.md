...
release in the 1.x line moves; `@v1.2.0` pins one release.
...
[Unreleased]: https://github.com/mcp-box/mcpscore-action/compare/v1.2.0...HEAD
[1.2.0]: https://github.com/mcp-box/mcpscore-action/compare/v1.1.1...v1.2.0
